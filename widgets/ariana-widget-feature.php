...
class Ariana_Widget_Feature extends WP_Widget {

	function __construct() {
		parent::__construct(
			'ariana_feature', __( 'Ariana - Feature', 'ariana-widgets' ), array(
				'description' => __( 'Add this widget in "Front page - Features".', 'ariana-widgets' ),
	...
	function default_array() {
		$defaults = array(
			'title' => 'Ariana - Feature',
			'text' => '',
			'image' => '',
			'icon'  => '',
			'color' => '',
			'con_class' =>  apply_filters( 'ariana_widget_feature_con_class_default', '' ),
			'icon_con_class' => apply_filters( 'ariana_widget_feature_icon_con_class_default', '' ),
			'content_con_class' => apply_filters( 'ariana_widget_feature_content_con_class_default', '' ),
		);
		return $defaults;
	}
	...
	public function widget_html( $instance ){
		...
		$output  = '<div class="' . esc_attr( apply_filters( 'ariana_widget_feature_con_class', $instance['con_class'] ) ) . '">';
		$output .=		'<div class="' . $instance_id . ' ' . esc_attr( apply_filters( 'ariana_widget_feature_icon_con_class', $instance['icon_con_class'] ) ) . '">';
		$output .=				$img_ico;
		$output .=		'</div>';
		$output .=		'<div class="' . esc_attr( apply_filters( 'ariana_widget_feature_content_con_class', $instance['content_con_class'] ) ) . '">';
